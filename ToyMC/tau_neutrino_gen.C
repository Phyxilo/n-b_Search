...
void tau_neutrino_gen() {
	// n = 2
	tau_neutrino_gen(400,2.0,0.4);
	tau_neutrino_gen(400,2.0,0.6);
	tau_neutrino_gen(400,2.0,0.8);
	tau_neutrino_gen(400,2.0,1.0);
	tau_neutrino_gen(400,2.0,1.2);
	tau_neutrino_gen(400,2.0,1.4);
	tau_neutrino_gen(400,2.0,1.6);
	
	// n = 2.5
	tau_neutrino_gen(400,2.5,0.4);
	tau_neutrino_gen(400,2.5,0.6);
	tau_neutrino_gen(400,2.5,0.8);
	tau_neutrino_gen(400,2.5,1.0);
	tau_neutrino_gen(400,2.5,1.2);
	tau_neutrino_gen(400,2.5,1.4);
	tau_neutrino_gen(400,2.5,1.6);

	// n = 3
	tau_neutrino_gen(400,3.0,0.4);
	tau_neutrino_gen(400,3.0,0.6);
	tau_neutrino_gen(400,3.0,0.8);
	tau_neutrino_gen(400,3.0,1.0);
	tau_neutrino_gen(400,3.0,1.2);
	tau_neutrino_gen(400,3.0,1.4);
	tau_neutrino_gen(400,3.0,1.6);

	// n = 3.5
	tau_neutrino_gen(400,3.5,0.4);
	tau_neutrino_gen(400,3.5,0.6);
	tau_neutrino_gen(400,3.5,0.8);
	tau_neutrino_gen(400,3.5,1.0);
	tau_neutrino_gen(400,3.5,1.2);
	tau_neutrino_gen(400,3.5,1.4);
	tau_neutrino_gen(400,3.5,1.6);

	// n = 4
	tau_neutrino_gen(400,4.0,0.4);
	tau_neutrino_gen(400,4.0,0.6);
	tau_neutrino_gen(400,4.0,0.8);
	tau_neutrino_gen(400,4.0,1.0);
	tau_neutrino_gen(400,4.0,1.2);
	tau_neutrino_gen(400,4.0,1.4);
	tau_neutrino_gen(400,4.0,1.6);

	// n = 4.5
	tau_neutrino_gen(400,4.5,0.4);
	tau_neutrino_gen(400,4.5,0.6);
	tau_neutrino_gen(400,4.5,0.8);
	tau_neutrino_gen(400,4.5,1.0);
	tau_neutrino_gen(400,4.5,1.2);
	tau_neutrino_gen(400,4.5,1.4);
	tau_neutrino_gen(400,4.5,1.6);

	// n = 5
	tau_neutrino_gen(400,5.0,0.4);
	tau_neutrino_gen(400,5.0,0.6);
	tau_neutrino_gen(400,5.0,0.8);
	tau_neutrino_gen(400,5.0,1.0);
	tau_neutrino_gen(400,5.0,1.2);
	tau_neutrino_gen(400,5.0,1.4);
	tau_neutrino_gen(400,5.0,1.6);

};


void tau_neutrino_gen(double E_beam, double n_inp, double b_inp) {
...
// SHiP fiducial setting ***
	...
	BH->Init(theta_box0,theta_box1,theta_box0,theta_box1,100);
...
// Drawings
	...
	sprintf( p_name,"tau_neutrino_gen_E%03.0lf_n%2.1lf_b%3.1lf.test.pdf",E_beam,n_inp,b_inp);
...
// 8th page  Ds->tau + neu_tau			interacted
	...
	FILE *fpo;
	char f_name[64];
	sprintf( f_name,"tau_neutrino_gen_E%03.0lf_n%2.1lf_b%3.1lf.pos.dat",E_beam,n_inp,b_inp);
	fpo= fopen(f_name,"wt");
